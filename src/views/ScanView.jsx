...
import LuminanceCard from '../components/LuminanceCard.jsx'

export default function ScanView({ kinetic, acoustic, atmospheric, atmosphericTier, magnetometer, luminance }) {
  return (
    <div className="view-enter" style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', padding: '1.25rem 1rem 1rem' }}>
      ...
      <LuminanceCard sensor={luminance} />
    </div>
  )
}
